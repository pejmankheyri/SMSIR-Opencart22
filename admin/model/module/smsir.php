...
class ModelModuleSmsir extends Model {
	...
	public function install() {
	   ...
	   if (version_compare(VERSION, '2.2.0.0', ">=")) {
		   	$this->model_extension_event->addEvent("smsir", 'catalog/controller/checkout/success/before', $this->module_path.'/onCheckout');
	    	$this->model_extension_event->addEvent("smsir", 'catalog/model/checkout/order/addOrderHistory/after', $this->module_path.'/onHistoryChange');
	    	$this->model_extension_event->addEvent("smsir", 'catalog/model/account/customer/addCustomer/after', $this->module_path.'/onRegister');	   	
	   } else {
		   	$this->model_extension_event->addEvent('smsir', 'post.order.add', $this->module_path.'/onCheckout');
	    	$this->model_extension_event->addEvent('smsir', 'post.order.history.add', $this->module_path.'/onHistoryChange');
	    	$this->model_extension_event->addEvent('smsir', 'post.customer.add', $this->module_path.'/onRegister');
	   }
	} 
